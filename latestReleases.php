...
<?php require_once "header.php"; ?>
                ...
                <div class="item">
                    <div class="container">
                        <div class="row">
                            ...
                            <h1 data-animate="fadeInDown">Search the Latest Releases by your Favorite Artists</h1>
                            <p  class="message" data-animate="fadeInUp">Billions, and Billions, and Billions of songs artists and albums are here, just serch them.</p>


                            <div class="col-md-6 col-md-offset-3" data-animate="fadeInUp">
                                <form action="" method="get" id="frm-landingPage1" class="form">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Search the latest by artists, albuns or songs" name="email" id="frm-landingPage1-email" >
        ...
        _________________________________________________________ -->
            <div class="section" id="section1">
                <div class="container">
                    <div class="col-md-12">
                        <h2 class="title" data-animate="fadeInDown">Latest Releases</h2>

                        <p class="lead">Listen to the latest releases of your favorite artists</p>
<?php
