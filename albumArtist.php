...
<?php require_once "header.php"; ?>
                ...
                <div class="item">
                    <div class="container">
                        <div class="row">
                            ...
                            <h1 data-animate="fadeInDown">Search specific songs in </h1>
                            <p  class="message" data-animate="fadeInUp">Type the name of the song to easily find it in the album</p>
        ...
        _________________________________________________________ -->
            <div class="section" id="section1">
                <div class="container">
                    <div class="col-md-12">
                        <h2 class="title" data-animate="fadeInDown">Songs in </h2>
