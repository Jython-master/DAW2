...
<?php require_once "header.php"; ?>
                ...
                <div class="item">
                    <div class="container">
                        <div class="row">
                            ...
                            <h1 data-animate="fadeInDown">Search your Favorite Artists</h1>
                            ...
                            <div class="col-md-6 col-md-offset-3" data-animate="fadeInUp">
                                <form action="" method="get" id="frm-landingPage1" class="form">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Artists, albuns or songs" name="email" id="frm-landingPage1-email" >
        ...
        _________________________________________________________ -->
            <div class="section" id="section1">
                <div class="container">
                    <div class="col-md-12">
                        <h2 class="title" data-animate="fadeInDown">Featured</h2>

                        <p class="lead">Listen to the artists that are trending right now</p>
